      ...
      <div className="min-h-screen bg-gray-50 flex">
        ...
        <aside className="w-64 bg-brand-black text-white flex flex-col fixed h-full z-20">
          <div className="p-6 border-b border-gray-800">
            ...
            <p className="text-sm text-gray-400 mt-1">Socorro dos Óculos</p>
          </div>
          ...
          <div className="p-4 border-t border-gray-800 space-y-2">
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 w-full py-2 bg-red-900/30 text-red-300 rounded-md text-sm hover:bg-red-900/50 transition-colors"
            >
