  ...
  return (
    <div className="bg-white">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 mb-16">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              ...
              <button className="flex-1 bg-[#FFD400] text-[#111111] font-black text-lg rounded-xl h-14 flex items-center justify-center gap-2 hover:bg-[#FFC107] hover:shadow-[0_0_25px_rgba(255,212,0,0.4)] transition-all duration-300 shadow-lg hover:scale-[1.02]">
            ...
            <div className="bg-gray-50 p-6 rounded-xl border border-gray-100 mb-8">
              ...
              <div className="flex gap-2">
                ...
                <button className="bg-[#111111] text-[#FFD400] font-semibold px-6 py-2 rounded-lg hover:bg-[#1A1A1A] transition-all duration-200 hover:scale-105">Calcular</button>
              </div>
            </div>
        ...
        {/* Why buy from us */}
        <div className="mt-16 bg-gradient-to-br from-[#111111] via-[#1A1A1A] to-[#111111] rounded-2xl p-8 md:p-10 border border-[#FFD400]/10">
