        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap justify-center lg:justify-start gap-4">
              <Link
                href="/contato"
                className="inline-flex items-center justify-center gap-2 bg-[#FFD400] text-[#111111] font-black py-4 px-8 rounded-xl hover:bg-yellow-300 transition-all duration-200 hover:scale-105 hover:shadow-[0_0_30px_rgba(255,212,0,0.35)] text-base"
              >
                Solicitar Orçamento
              ...
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 border-2 border-white/20 text-white font-bold py-4 px-8 rounded-xl hover:border-[#FFD400] hover:text-[#FFD400] transition-all duration-200 text-base"
              >
                Ver Produtos
              </Link>
            </div>
            ...
            <div className="relative z-10 w-full max-w-xs sm:max-w-sm">
              <div className="grid grid-cols-2 gap-2.5 sm:gap-3 mb-2.5 sm:mb-3">
                {services.map(({ icon: Icon, title, desc }, i) => (
                  <div
                    key={title}
                    className={`rounded-2xl p-4 sm:p-5 border hover:border-[#FFD400]/50 transition-all duration-300 hover:-translate-y-1 ${i % 2 === 0 ? 'bg-[#FFD400]/10 border-[#FFD400]/20' : 'bg-white/5 border-white/10'}`}
                  >
