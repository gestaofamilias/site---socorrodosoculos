    ...
    <section className="py-16 bg-[#111111]">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-12">
          ...
          <div className="relative rounded-2xl overflow-hidden group">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-gradient-to-t from-black/60 to-transparent">
              <span className="bg-[#FFD400] text-[#111111] font-black text-lg px-6 py-2 rounded-full mb-3 shadow-lg">DEPOIS</span>
        ...
        <div className="bg-[#FFD400] rounded-2xl p-8 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <Link
            href="/contato"
            className="inline-flex items-center gap-2 bg-[#111111] text-[#FFD400] font-black px-8 py-4 rounded-xl hover:bg-black transition-all duration-200 hover:scale-105 hover:shadow-lg text-base flex-shrink-0"
          >
            Solicitar Orçamento
