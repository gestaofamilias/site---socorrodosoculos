...
export default function PriceRanges() {
  return (
    <section className="relative py-16 bg-gradient-to-br from-[#111111] via-[#1A1A1A] to-[#111111] overflow-hidden">
      <div className="absolute top-0 right-0 w-96 h-96 bg-[#FFD400]/10 rounded-full blur-3xl translate-x-1/2 -translate-y-1/2" />
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-12">
          ...
          <div className="relative rounded-2xl overflow-hidden group">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-gradient-to-t from-[#111111]/80 to-transparent">
              <span className="bg-[#FFD400] text-[#111111] font-black text-lg px-6 py-2 rounded-full mb-3 shadow-[0_0_20px_rgba(255,212,0,0.4)]">DEPOIS</span>
