...
export default function ProductCard({ product }: { product: Product }) {
  return (
    <div className="group flex flex-col bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-xl hover:shadow-black/5 transition-all duration-300 hover:-translate-y-1 overflow-hidden relative">
      ...
      <div className="p-5 flex flex-col flex-grow border-t border-gray-50">
        ...
        <Link href={`/produto/${product.slug}`}>
          <h3 className="font-heading font-semibold text-[#111111] text-sm mb-3 line-clamp-2 hover:text-[#FFD400] transition-colors leading-snug">
            {product.name}
          </h3>
        </Link>
        ...
        <div className="mt-auto pt-3 border-t border-gray-50">
          ...
          <button className="w-full flex items-center justify-center gap-2 bg-[#111111] text-[#FFD400] font-black py-3 rounded-xl hover:bg-[#FFD400] hover:text-[#111111] transition-all duration-200 hover:scale-[1.02] hover:shadow-md text-sm group/btn">
