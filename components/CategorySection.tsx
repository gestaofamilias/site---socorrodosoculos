    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <span className="text-[#FFC107] text-xs font-black uppercase tracking-widest mb-2 block">Navegue por categoria</span>
          <h2 className="font-heading text-3xl md:text-4xl font-black text-[#111111]">Compre por Categoria</h2>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {categories.map((category, index) => (
            <Link
              key={index}
              href={category.link}
              className="group bg-white border border-gray-100 rounded-2xl overflow-hidden shadow-sm hover:shadow-2xl hover:shadow-[#FFD400]/25 transition-all duration-300 hover:-translate-y-2"
            >
              <div className="relative h-56 w-full overflow-hidden">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#111111]/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
              </div>
              <div className="p-5 border-t-2 border-transparent group-hover:border-[#FFD400] transition-colors duration-300">
                ...
                <span className="inline-flex items-center gap-1 text-xs font-bold text-[#111111] group-hover:text-[#FFC107] transition-colors duration-200">
